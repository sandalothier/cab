...
@RestController
@RequestMapping("/api/cabinet-kafka")
public class CabinetKafkaResource {
    private final Logger log = LoggerFactory.getLogger(CabinetKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CabinetKafkaResource(KafkaProperties kafkaProperties) {
